    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('UTILISATEUR', 'Utilisateur'), ('RECEPTIONNISTE', 'Réceptionniste'), ('REDACTEUR', 'Rédacteur'), ('WEBMASTER', 'Webmaster'), ('ADMINISTRATEUR', 'Administrateur')], default='UTILISATEUR', max_length=20)),
                ('photo', models.ImageField(blank=True, null=True, upload_to='images/utilisateur')),
                ('carteCredit', models.CharField(default='', max_length=50)),
