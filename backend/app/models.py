...
class Rooms(models.Model):
    ...
    adultes = models.PositiveIntegerField(null=True, blank=True)
    enfants = models.PositiveIntegerField(null=True, blank=True)
    ...
    prom_start = models.DateField(null=True, blank=True)
    prom_end = models.DateField(null=True, blank=True)
