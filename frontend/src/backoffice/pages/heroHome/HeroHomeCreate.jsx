...
export default function HeroHomeCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://127.0.0.1:8000/api/backoffice/heroHome/', formData, {
        headers: {
  ...
  return (
    <div className="container mx-auto p-4">
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded shadow-md">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="best">
            Best
          </label>
          <input
            id="best"
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="etoiles">
            Etoiles
          </label>
          <input
            min={0}
