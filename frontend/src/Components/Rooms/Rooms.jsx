...
const Rooms = () => {
  ...
  useEffect(() => {
    const fetchRooms =async ()=> {
      try{
        const response = await axios.get('/api/backoffice/rooms/random/')
      ...
      <div className=" py-20 2xl:py-[120px] w-full bg-[url('/images/home-1/section-shape2.png')] bg-no-repeat bg-top bg-opacity-[0.07]">
        <div className="Container ">
          ...
          <div className="relative">
            <div className="mt-14 2xl:mt-[60px] keen-slider flex gap-5 " ref={sliderRef}>
              ...
              {/* slide - 1 */}
                  {
                    ...
                    rooms.map((room)=> {
                      return(
                          <div className="keen-slider__slide number-slide1 " key={room.id}>
